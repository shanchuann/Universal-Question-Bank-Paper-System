...
public class AnnouncementService {
  ...
  /** 创建公告 */
  public AnnouncementEntity createAnnouncement(
      String title, String content, String priority, String authorId) {
  ...
  /** 更新公告 */
  public AnnouncementEntity updateAnnouncement(
      String id, String title, String content, String priority) {
  ...
  public AnnouncementEntity publishAnnouncement(String id) {
    ...
    notificationService.createAnnouncementNotifications(saved);
    notifyUsers(saved);
    return saved;
  }

  private void notifyUsers(AnnouncementEntity announcement) {
    ...
    for (UserEntity user : users) {
      ...
      emailService.sendAnnouncementNotification(
          user.getEmail(), receiver, announcement.getTitle(), announcement.getContent());
    }
  }
